...
export const metadata: Metadata = {
  title:
    "Decorating & Tiling Services in Wellington, Taunton & Tiverton | Jason Chapman",
  description:
    "Interior decorating and tiling services for homeowners in Wellington, Taunton, Tiverton and surrounding areas.",
};
    ...
    <>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-6">
            Interior decorating and tiling services
          </h1>
          <p className="text-lg text-slate-600 mb-8 leading-relaxed">
            Jason Chapman provides interior painting, decorating and tiling for
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              professional finish. From walls and ceilings to woodwork and full
              room refreshes, the focus is always on good preparation and a
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              other interior spaces. Whether you are updating a splashback,
              retiling a bathroom or laying a tiled floor, Jason works carefully
              to deliver clean lines, tidy finishing and a high-quality result.
            </p>
            <div className="grid grid-cols-2 gap-4 mb-8">
              <ul className="space-y-2">
      ...
      <section className="bg-primary text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">
            Looking for decorating or tiling work to be done properly?
          </h2>
